      ...
      <template #detail>
        <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol" name="NekoCustomInfoForm">
          <a-row>
						...
						<a-col :span="12">
							<a-form-item label="昵称" v-bind="validateInfos.nickName" id="NekoCustomInfoForm-nickName" name="nickName">
						...
						<a-col :span="12">
							<a-form-item label="性别" v-bind="validateInfos.gender" id="NekoCustomInfoForm-gender" name="gender">
						...
						<a-col :span="12">
							<a-form-item label="头像" v-bind="validateInfos.avatar" id="NekoCustomInfoForm-avatar" name="avatar">
						...
						<a-col :span="12">
							<a-form-item label="推荐人ID" v-bind="validateInfos.recommenderId" id="NekoCustomInfoForm-recommenderId" name="recommenderId">
								<j-search-select v-model:value="formData.recommenderId" dict=""  allow-clear />
							</a-form-item>
						</a-col>
						<a-col :span="12">
							<a-form-item label="会员ID" v-bind="validateInfos.memberId" id="NekoCustomInfoForm-memberId" name="memberId">
								<j-select-multiple type="list_multi" v-model:value="formData.memberId" dictCode="" placeholder="请选择会员ID"  :triggerChange="false"/>
							</a-form-item>
						</a-col>
						<a-col :span="12">
							<a-form-item label="标签" v-bind="validateInfos.tagConfig" id="NekoCustomInfoForm-tagConfig" name="tagConfig">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../NekoCustomInfo.api';
