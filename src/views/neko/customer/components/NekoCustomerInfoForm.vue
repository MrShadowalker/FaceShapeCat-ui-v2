          ...
          <a-row>
            <a-col :span="12">
              <a-form-item label="顾客姓名" v-bind="validateInfos.name" id="NekoCustomerInfoForm-name" name="name">
                <a-input v-model:value="formData.name" placeholder="请输入顾客姓名" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="12">
            ...
            <a-col :span="12">
              <a-form-item label="电话" v-bind="validateInfos.phoneNum" id="NekoCustomerInfoForm-phoneNum" name="phoneNum">
                <a-input v-model:value="formData.phoneNum" placeholder="请输入电话" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="微信号" v-bind="validateInfos.wechatNum" id="NekoCustomerInfoForm-wechatNum" name="wechatNum">
                <a-input v-model:value="formData.wechatNum" placeholder="请输入微信号" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="12">
            ...
            <a-col :span="12">
              <a-form-item label="头像" v-bind="validateInfos.avatar" id="NekoCustomerInfoForm-avatar" name="avatar">
                <j-image-upload :fileMax="0" v-model:value="formData.avatar" />
              </a-form-item>
            </a-col>
            <a-col :span="12">
            ...
            <a-col :span="12">
              <a-form-item label="标签" v-bind="validateInfos.tagConfig" id="NekoCustomerInfoForm-tagConfig" name="tagConfig">
                <a-input v-model:value="formData.tagConfig" placeholder="请输入标签" allow-clear />
              </a-form-item>
            </a-col>
          </a-row>
        </a-form>
